...
![Window](images/explorer_3hojeUZi8n.png)

The setup is similar to a multi-track timeline, but instead has tracks for `LEFT`, and `RIGHT`. Drag your media into each track to play them together. The default option is side-by-side.

![Window](images/ump_B4FEC9DhqF.png)

This button will change to a split screen view where you can drag the divider as you play.

![Window](images/ump_5KYqdcvXnx.png)
...
![Window](images/Code_dby8rQH7Yr.png)
...
![Window](images/ump_DfeVF1d8pu.png)
