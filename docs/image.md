...
Adjust cache size and behavior in the **Pipeline & Cache Settings** panel. See the [Settings](https://qcview.app/settings/) page for details.
...
> The playback cache is RAM-based and subject to the Memory Safety system. If system RAM is full, image playback will pause. See the [Memory](https://qcview.app/memory-safety/) page for details.

> You can switch EXR layers after loading — see the [Inspector](https://qcview.app/inspector/).
