...
Use the sidebar to browse the full manual, including [installation](installation), [playback basics](basics), [color management](color), [annotations](annotations), and more.
