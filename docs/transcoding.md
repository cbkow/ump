...
![Window](images/ump_ASKIbmX4IC.png)
...
![Window](images/ump_ZshbOF2XKw.png)

Submitting will add to the **Queue Manager** and automatically begin transcoding.

![Window](images/ump_tvmJmmOs6G.png)

## Loop in/out points

![window](images/explorer_tQrN71mPY1.png)
The loop-in/out functions will also trim a region for transcoding. If you don't want to export the whole video/sequence, you can trim here.
