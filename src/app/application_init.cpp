...
bool Application::Initialize(const std::vector<std::string>& initial_files) {
        ...
        // Native macOS window — no GLFW
        {
            ...
            if (!MacOS_CreateWindow(saved_window_width, saved_window_height, wx, wy, "QCView v1.1.3")) {
        ...
        window = glfwCreateWindow(saved_window_width, saved_window_height, "QCView v1.1.3", nullptr, nullptr);
        if (!window) {
