...
namespace qcview {
    ...
    public:
        ...
        // OCIO config tracking (for transcode)
        void SetActiveOCIOConfig(OCIOConfigType config_type) { active_ocio_config_ = config_type; }
        OCIOConfigType GetActiveOCIOConfig() const { return active_ocio_config_; }
    ...
    private:
        ...
        // OCIO config tracking
        OCIOConfigType active_ocio_config_ = OCIOConfigType::BLENDER;  // Default to Blender
