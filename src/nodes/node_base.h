...
namespace qcview {
    ...
    public:
        ...
        const std::string& GetDisplayAlias() const { return display_alias; }
        const std::string& GetViewAlias() const { return view_alias; }
        ...
        // Set display with both full name and alias (for config portability)
        void SetDisplayWithAlias(const std::string& display, const std::string& alias) {
            display_name = display;
            display_alias = alias;
            UpdateTitle();
        }

        // Set view with both full name and alias (for config portability)
        void SetViewWithAlias(const std::string& view, const std::string& alias) {
            view_name = view;
            view_alias = alias;
            UpdateTitle();
        }
    ...
    private:
        ...
        std::string display_alias;  // Portable alias for cross-config compatibility
        std::string view_alias;     // Portable alias for cross-config compatibility
