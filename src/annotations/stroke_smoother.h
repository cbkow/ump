...
/**
 * @deprecated Use InkStrokeModelerWrapper for new strokes.
 *
 * StrokeSmoother is retained only for rendering legacy v1.0 annotations
 * that store raw points (is_modeled = false). New strokes created with
 * the ink-stroke-modeler are already smoothed at input time.
 *
